...
class Updatestudent extends JFrame implements  ActionListener {
    ...
    JTextField t,t1,t2,t3,t4,t5,t6,t7,t8,t9,t12;
    JButton b,b1,b2;
    JComboBox c1, c2;
    String id_emp;
    ...
    Updatestudent() {
        ...
        lab1 = new JLabel("Enter Student ID to update the data of student");
        ...
        c2.setBounds(600, 380, 100, 30);
        add(c2);

        id12 = new JLabel("Course");
        id12.setBounds(50, 450, 100, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b) {
            try {
                conn con = new conn();
                String str = "Update student set name='" + t1.getText() + "',division='" + t2.getText() + "',DOB='" + t3.getText() + "',Email='" + t4.getText() +"',Aadhar_no ='" + t5.getText() +"',X='" + t6.getText() +
                        "',XII='" + t7.getText() +"',year='" +(String)c2.getSelectedItem() +"',course='" + (String)c1.getSelectedItem() +"' where id ='"+t12.getText()+"'" ;
...
//                String str2 = t12.getText();
                ...
                if (rs.next()) {
                    ...
                    t2.setText(rs.getString("division"));
